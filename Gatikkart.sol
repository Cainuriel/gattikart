...
| $$  \ $$ /$$__  $$  | $$ /$$| $$ /$$| $$| $$_  $$  /$$__  $$| $$        | $$ /$$
|  $$$$$$/|  $$$$$$$  |  $$$$/|  $$$$/| $$| $$ \  $$|  $$$$$$$| $$        |  $$$$/
 \______/  \_______/   \___/   \___/  |__/|__/  \__/ \_______/|__/         \___/
**/

import "https://github.com/Cainuriel/EIP2981-implementation/blob/main/contracts/ERC2981ContractWideRoyalties.sol";
import "@openzeppelin/contracts/token/ERC721/extensions/ERC721Enumerable.sol";
import "@openzeppelin/contracts/access/Ownable.sol";

contract Gatikkart is ERC721Enumerable, Ownable, ERC2981ContractWideRoyalties  
{   
    ...
    uint256 public _tokenPrice = 30000000000000000000; //30 MATIC
  ...
  event WithdrawTime(
    ...
    constructor() 
    ERC721("Gattikart Genesis", "GATTIKAART") 
    {
    ...
    {
    require(saleIsActive, "Salemint must be active to buy NFTs");
